...
- **Copy** _(optional)_: Product description text — used as a spec extraction source if structured specs are unavailable
...
- Convert sentence form to key-value form: _"The body is made of poplar"_ → `Body Material: Poplar`
...
| **Shipping**       | Box dimensions, shipping weight _(see Shipping Specs section)_ |
| **Identifiers**    | MPN, EAN — _UPC is handled by `skills/product-upc.md`_         |
...
> _"Run product-custom-fields for [Brand] [Model] [SKU]"_"
